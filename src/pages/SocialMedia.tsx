  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-1 space-y-6 bg-zinc-950 p-6 rounded-2xl border border-zinc-800">
          <div>
        ...
        <div className="lg:col-span-2">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {images.map((img, idx) => (
              ...
              >
                <img src={img} alt="Generated" className="w-full h-full object-cover" referrerPolicy="no-referrer" />
              </motion.div>
            ))}
            {images.length === 0 && !loading && (
              <div className="col-span-full h-64 border-2 border-dashed border-zinc-800 rounded-2xl flex items-center justify-center text-zinc-500">
