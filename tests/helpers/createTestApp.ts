...
export function createTestApp() {
   ...
   * Returns 503 if ffmpeg unavailable (stubbed as unavailable in tests),
  ...
  api.get("/compose/templates", (_req, res) => {
    // Stub: returns empty array (Lane 3 templates may or may not exist)
    res.json([]);
  });
